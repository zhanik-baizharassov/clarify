    ...
    <header className="sticky top-0 z-50 border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="relative mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <details className="group md:hidden">
          <summary
            className="flex h-11 w-11 list-none items-center justify-center rounded-xl border bg-background transition hover:bg-muted/40 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background focus:ring-offset-background [&::-webkit-details-marker]:hidden"
